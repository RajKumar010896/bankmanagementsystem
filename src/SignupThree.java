...
public class SignupThree  extends JFrame implements ActionListener
{
    ...
    SignupThree(String formno)
    {
        ...
        c7 = new JCheckBox("I heerby declared taht the above entered details are correct to the best of knowledge");
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource() == submit){
            ...
            if (c1.isSelected()){
                ...
                facility = facility + " Chequed Book";
            }  if (c6.isSelected()) {
            ...
            try{
                if (accountType.equals("")) {
                    ...
                    try(PreparedStatement preparedStatement = conn.conn.prepareStatement(query1)){
                    ...
                    String query2 = "INSERT INTO login VALUE(?,?,?)";
                    try(PreparedStatement preparedStatement = conn.conn.prepareStatement(query2)){
                        preparedStatement.setString(1,formno);
